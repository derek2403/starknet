...
trait IActions<T> {
    ...
    fn store_message(ref self: T, content: felt252);
}
...
pub mod actions {
    ...
    use dojo_starter::models::{Vec2, Moves, DirectionsAvailable, Message};
    ...
    impl ActionsImpl of IActions<ContractState> {
        ...
        fn store_message(ref self: ContractState, content: felt252) {
            let mut world = self.world_default();
            let player = get_caller_address();
            ...
            // Emit event
            world.emit_event(@MessageStored { player, content });
        }
    }
